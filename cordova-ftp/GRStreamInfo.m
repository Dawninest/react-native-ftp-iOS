...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _queue = dispatch_queue_create("SANFtpTools-Dawninest.streaminfo", DISPATCH_QUEUE_CONCURRENT);
    }
...
- (void)uploadStart:(GRRequest *)request{
    [request.delegate uploadRequestStart:request];
}
